...
export class SetupHippopotamusNewGenAnim extends cc.Component {
    ...
    private _setupMovementGraph (graph: cc.animation.PoseSubgraph) {
        ...
        movementBlending.children = [
            [createPoseFromClip(this._getClip('Hippo_Armature|Idle')), 0.0],
            [createPoseFromClip(this._getClip('Hippo_Armature|Walk')), 1.0],
        ];
    ...
    private _setupIdleGraph (graph: cc.animation.PoseSubgraph) {
        ...
        const idles: [cc.animation.PoseNode, number][] = [
            [createPoseNodeFromClip(graph, this._getClip('Hippo_Armature|Idle')), 0.5],
            [createPoseNodeFromClip(graph, this._getClip('Hippo_Armature|Idle1')), 0.3],
            [createPoseNodeFromClip(graph, this._getClip('Hippo_Armature|Idle2')), 0.2],
        ];
